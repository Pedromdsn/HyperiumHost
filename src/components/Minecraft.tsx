		...
		<div className="cinzaClaro rounded-xl mt-20 mb-10">
			...
			<div>
				...
				<h2 className="mt-8 text-gray-300 text-lg">
					De <strong>R$ {props.tamanho * 5}</strong> por
				</h2>
				<div className="flex text-center items-end justify-center">
					<h2 className="text-5xl font-semibold">R$ {props.tamanho * 4}</h2>
				...
				<p className="text-center mt-10 pb-10 text-lg">
					...
					<br /> Ping de 100 ~ 150ms
					{props.tamanho >= 20 && (
						<>
							<br />
							Loja para venda de vips{" "}
						</>
					)}
					{props.tamanho >= 10 && (
						<>
							<br /> Domínio (.com ou .net)
						</>
					)}
				</p>
			</div>
